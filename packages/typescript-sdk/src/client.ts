...
class PluginsClient {
  ...
  async updatePluginSettings(
    pluginId: string,
    data: components['schemas']['UpdatePluginSettings']
  ): Promise<components['schemas']['Plugin']> {
...
class AnalysisClient {
  ...
  async createClassifier(
    data: components['schemas']['CreateClassifier']
  ): Promise<components['schemas']['Classifier']> {
   ...
   * List classifiers
   */
  async listClassifiers(): Promise<
    components['schemas']['ClassifierSummary'][]
  > {
    const url = `analysis/classifiers`;
    const response = await this.httpClient.get(url);
    return response.data;
  ...
  async getClassifier(
    ...
    const url = `analysis/classifiers/${encodeURIComponent(
      String(classifierId)
    )}`;
    const response = await this.httpClient.get(url);
    return response.data;
  ...
  async updateClassifier(
    classifierId: string,
    data: components['schemas']['UpdateClassifier']
  ): Promise<components['schemas']['Classifier']> {
    const url = `analysis/classifiers/${encodeURIComponent(
      String(classifierId)
    )}`;
   ...
   */
  async listClassificationProviders(): Promise<
    components['schemas']['ClassificationProvider'][]
  > {
...
class MediaClient {
   ...
   */
  async listMediaContainers(options?: {
    cursor?: string;
    pageSize?: number;
    collectionIds?: string[];
  }): Promise<components['schemas']['ListMediaContainersResponse']> {
   ...
   */
  async createMedia(
    data: components['schemas']['CreateMediaContainer']
  ): Promise<components['schemas']['CreateMediaContainerResponse']> {
  ...
  async getMedia(
    containerId: string
  ): Promise<components['schemas']['MediaContainer']> {
  ...
  async updateMedia(
    containerId: string,
    data: components['schemas']['UpdateMediaContainer']
  ): Promise<components['schemas']['MediaContainer']> {
    const url = `media/containers/${encodeURIComponent(String(containerId))}`;
    const response = await this.httpClient.patch(url, data);
    return response.data;
  ...
  async deleteMedia(
    containerId: string,
    data: components['schemas']['DeleteMediaContainer']
  ): Promise<void> {
    const url = `media/containers/${encodeURIComponent(String(containerId))}`;
  ...
  async createCollection(
    data: components['schemas']['CreateCollection']
  ): Promise<components['schemas']['Collection']> {
  ...
  async listCollections(options?: {
    cursor?: string;
    pageSize?: number;
  }): Promise<components['schemas']['ListCollectionsResponse']> {
    const params = new URLSearchParams();
    if (options) {
      if (options.cursor !== undefined) {
        params.append('cursor', String(options.cursor));
  ...
  async getCollection(
    id: string
  ): Promise<components['schemas']['CollectionDetails']> {
  ...
  async updateCollection(
    id: string,
    data: components['schemas']['UpdateCollection']
  ): Promise<components['schemas']['CollectionDetails']> {
    const url = `media/collections/${encodeURIComponent(String(id))}`;
    const response = await this.httpClient.patch(url, data);
    return response.data;
   ...
   */
  async generateLinks(
    data: components['schemas']['GenerateMediaLinks']
  ...
  async upload(
    ...
    const queryString = params.toString();
    const url = `media/containers/${encodeURIComponent(
      String(containerId)
    )}/upload${queryString ? `?${queryString}` : ''}`;
...
class StorageClient {
  ...
  async createStorageUnit(
    data: components['schemas']['CreateStorageUnit']
  ): Promise<components['schemas']['StorageUnit']> {
   ...
   * List storage units
   */
  async listStorageUnits(options?: {
    cursor?: string;
    pageSize?: number;
    configId?: string;
  }): Promise<components['schemas']['ListStorageUnitsResponse']> {
    const params = new URLSearchParams();
    if (options) {
      if (options.cursor !== undefined) {
        params.append('cursor', String(options.cursor));
  ...
  async updateStorageUnit(
    storageUnitId: string,
    data: components['schemas']['UpdateStorageUnit']
  ): Promise<components['schemas']['StorageUnit']> {
    const url = `storage/units/${encodeURIComponent(String(storageUnitId))}`;
    const response = await this.httpClient.patch(url, data);
    return response.data;
  ...
  async createStorageConfig(
    data: components['schemas']['CreateStorageConfig']
  ): Promise<components['schemas']['StorageConfig']> {
   ...
   */
  async listStorageConfigs(options?: {
    providerId?: string;
  }): Promise<components['schemas']['StorageConfigSummary'][]> {
    const params = new URLSearchParams();
    if (options) {
  ...
  async updateStorageConfig(
    id: string,
    data: components['schemas']['UpdateStorageConfig']
  ): Promise<components['schemas']['StorageConfig']> {
    const url = `storage/configs/${encodeURIComponent(String(id))}`;
    const response = await this.httpClient.patch(url, data);
    return response.data;
...
class SearchClient {
  ...
  async createSearchIndex(
    data: components['schemas']['CreateSearchIndex']
  ): Promise<components['schemas']['SearchIndex']> {
   ...
   */
  async listVectorProviders(): Promise<
    components['schemas']['VectorProvider'][]
  > {
  ...
  async updateVectorProviderConfig(
    providerId: string,
    data: components['schemas']['UpdateVectorProviderConfig']
  ): Promise<components['schemas']['VectorProvider']> {
    const url = `search/vector-providers/${encodeURIComponent(
      String(providerId)
    )}`;
    const response = await this.httpClient.patch(url, data);
    return response.data;
